#ifndef NEOMINIMASILM_ENTITIES_LEVEL_PICKUPS_HEALTH_H_
#	define NEOMINIMASILM_ENTITIES_LEVEL_PICKUPS_HEALTH_H_

#include "src/entity/CollisionType.hpp"
#include "src/physics/bounding/BoundingBox.hpp"

class Health : public CollisionType {
public:

	Health(SharedShape s, const util::vec::Vector3D& p);
